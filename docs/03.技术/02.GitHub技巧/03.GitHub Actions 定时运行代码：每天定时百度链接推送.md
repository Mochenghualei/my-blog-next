...
![主动提交](https://cdn.staticaly.com/gh/xugaoyi/image_store/blog/20210103124306.png)

具体使用方法就是创建一个文件`urls.txt`，文件内每行一条链接的格式写入提交的多个链接，如图。

![urls.txt](https://cdn.staticaly.com/gh/xugaoyi/image_store/blog/20210103124305.png)
