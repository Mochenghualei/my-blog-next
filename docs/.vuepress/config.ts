/**
 *js版本配置文件：https://github.com/xugaoyi/vuepress-theme-vdoing/tree/a2f03e993dd2f2a3afdc57cf72adfc6f1b6b0c32/docs/.vuepress
 */
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  base: '/my-blog-next/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  ...
  themeConfig: {
    ...
    repo: "Mochenghualei", // 导航栏右侧生成Github链接
    ...
    // bodyBgImg: "/img/test.jpeg", // body背景大图，默认无。 单张图片 String | 多张图片 Array, 多张图片时隔bodyBgImgInterval切换一张。
    ...
    author: {
      name: "shuai", // 必需
      link: "https://github.com/Mochenghualei", // 可选的
    },
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          ...
          title: "Bilibili",
          link: "https://space.bilibili.com/278851804?spm_id_from=333.999.0.0",
        },
      ],
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'mocheng | <a href="https://github.com/Mochenghualei" target="_blank">Github</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  plugins: <UserPlugins>[
    ...
    //   {
    //     apiKey: 'b0a5a108729a279ea6f8a31d5f73ad4a',
    //     indexName: 'my--next',
    //     appId: 'XUQ5NIP0LD',
    //     placeholder: '搜索文档',
    //     translations: {
